...
#<<хелп--------->>
    ...
    async def правила(self, ctx):
        ...
        emb = discord.Embed(colour = config.EMBED_COLOR, title = '**ПРАВИЛА ЗАПРЕЩАЮТ:**')
        emb.add_field(name = '⁣⁣Создавать срача/унижения и издевательства', value = 'Мут до 2 часов/кик/бан', inline = False)
        emb.add_field(name = '⁣⁣Оскорблять участников/проект', value = 'Мут до 3 часов/бан', inline = False)
        emb.add_field(name = '⁣⁣Черезмерное употреблять маты', value = 'Мут до 30 минут', inline = False)
        emb.add_field(name = '⁣⁣Рекламировать сторонние ресурсы, иные контенты в ЛС/чатах', value = 'Мут 30 минут/кик. Повторно - бан', inline = False)
        emb.add_field(name = 'Распространять личную информацию', value = 'Мут до 2 часов/кик/бан', inline = False)
        emb.add_field(name = '⁣⁣Обман, мошенничество, шантаж, а также продажа чего либо или предложения «халявы»', value = 'Бан', inline = False)
        emb.add_field(name = '⁣⁣Рассылать материалы в виде: порнографии, «хентай», насилие, вредные привычки (алкоголь, наркотики)', value = 'Бан без возможности разжалования', inline = False)
        emb.add_field(name = '⁣⁣Пропагандировать ненависть к национальному, половому, религиозному признаку. Пропаганда завуалированая/прямая', value = 'Бан без возможности разжалования', inline = False)
        emb.add_field(name = '⁣Попрошайничать роли/деньги/должности', value = 'мут до 30 минут/кик/бан', inline = False)
        emb.add_field(name = '⁣Выдавать себя за другого человека', value = 'Мут до 40 минут/бан', inline = False)
